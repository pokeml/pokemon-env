...
const Tools = {
    ...
    getPokemonIcon(pokemon, facingLeft) {
        ...
        if (pokemon && pokemon.num !== undefined)
            num = pokemon.num;
        else if (BattlePokemonSprites && BattlePokemonSprites[id] && BattlePokemonSprites[id].num)
            num = BattlePokemonSprites[id].num;
        else if (BattlePokedex && BattlePokedex[id] && BattlePokedex[id].num)
    ...
    getTeambuilderSprite(pokemon, gen = 0) {
        if (!pokemon)
            return '';
        ...
        if (gen <= 1 && template.gen <= 1)
            spriteDir = Tools.resourcePrefix + 'sprites/rby';
        else if (gen <= 2 && template.gen <= 2)
            spriteDir = Tools.resourcePrefix + 'sprites/gsc';
        else if (gen <= 3 && template.gen <= 3)
            spriteDir = Tools.resourcePrefix + 'sprites/rse';
        else if (gen <= 4 && template.gen <= 4)
            spriteDir = Tools.resourcePrefix + 'sprites/dpp';
